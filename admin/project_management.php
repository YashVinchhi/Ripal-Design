  ...
  <div class="min-h-screen flex flex-col">
    ...
    <main class="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 project-grid-mobile">
            ...
            <div class="project-card group bg-white border border-gray-100 shadow-premium hover:shadow-premium-hover transition-all duration-500 overflow-hidden flex flex-col" data-region="<?php echo htmlspecialchars($pRegion); ?>" data-status="<?php echo htmlspecialchars($pStatus); ?>">
                <div class="h-56 project-card-media bg-foundation-grey relative overflow-hidden">
    ...
    <div id="ventureModal" class="fixed inset-0 bg-black/80 backdrop-blur-md z-[100] hidden items-center justify-center p-4">
        <div class="bg-white max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl border-b-4 border-rajkot-rust">
            ...
            <form method="post" class="venture-modal-form p-10 space-y-8" id="ventureForm" onsubmit="handleVentureSubmit(event)">
