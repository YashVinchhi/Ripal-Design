    ...
    <main class="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8 md:mb-12">
            <div class="bg-white p-6 md:p-8 shadow-premium border border-gray-100 relative group overflow-hidden">
                ...
                <span class="text-2xl md:text-3xl font-serif font-bold text-foundation-grey">124</span>
            </div>
            <div class="bg-white p-6 md:p-8 shadow-premium border border-gray-100 border-b-2 border-b-rajkot-rust relative group overflow-hidden">
                ...
                <span class="text-2xl md:text-3xl font-serif font-bold text-rajkot-rust">42</span>
            </div>
            <div class="bg-white p-6 md:p-8 shadow-premium border border-gray-100 border-b-2 border-b-approval-green relative group overflow-hidden">
                ...
                <span class="text-2xl md:text-3xl font-serif font-bold text-approval-green">68</span>
            </div>
            <div class="bg-white p-6 md:p-8 shadow-premium border border-gray-100 border-b-2 border-b-slate-accent relative group overflow-hidden">
                ...
                <span class="text-2xl md:text-3xl font-serif font-bold text-slate-accent">14</span>
            </div>
        </div>
        ...
        <div class="bg-white shadow-premium border border-gray-100 p-4 md:p-6 mb-8 flex flex-col lg:flex-row justify-between items-center gap-4 md:gap-6">
            <div class="relative w-full lg:w-96">
                ...
                <input type="search" placeholder="Filter identities..." class="w-full pl-12 pr-6 py-3 md:py-4 bg-gray-50 border border-gray-50 outline-none focus:bg-white focus:border-rajkot-rust transition-all text-sm font-medium">
            </div>
            <div class="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
                <select class="w-full sm:w-auto py-3 md:py-4 px-6 bg-gray-50 border border-gray-50 text-[10px] font-bold uppercase tracking-widest outline-none focus:bg-white focus:border-rajkot-rust transition-all cursor-pointer">
                ...
                <button class="bg-foundation-grey hover:bg-rajkot-rust text-white px-6 py-3 md:py-4 text-[10px] font-bold uppercase tracking-[0.2em] transition-all flex items-center justify-center shadow-lg active:scale-95">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm border-collapse admin-table">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <!-- Row 1 -->
                        <tr class="group hover:bg-gray-50/50 transition-all duration-300 block md:table-row mb-4 md:mb-0 border md:border-0 rounded-lg md:rounded-none bg-white md:bg-transparent">
                            <td class="px-6 md:px-8 py-4 md:py-6 block md:table-cell" data-label="Identity Profile">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-[10px] text-gray-400 font-mono tracking-tighter uppercase opacity-70 text-wrap break-all">admin@ripaldesign.in</p>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 md:px-8 py-4 md:py-6 text-gray-400 text-[11px] font-medium italic block md:table-cell" data-label="Last Sync">Active Now</td>
                            <td class="px-6 md:px-8 py-6 md:py-6 block md:table-cell" data-label="Registry Actions">
                                <div class="flex flex-row md:justify-end gap-3 mt-4 md:mt-0">
                                    <a href="../dashboard/profile.php?user=ashish" class="flex-grow md:flex-grow-0 h-11 w-11 bg-gray-50 md:bg-transparent text-gray-400 hover:text-rajkot-rust transition-colors flex items-center justify-center border border-gray-100 md:border-0 rounded" title="View Profile">
                                        <i data-lucide="eye" class="w-5 h-5 md:w-4 md:h-4"></i>
                                    </a>
                                    <a href="add_user.php?id=1" class="flex-grow md:flex-grow-0 h-11 w-11 bg-gray-50 md:bg-transparent text-gray-400 hover:text-foundation-grey transition-colors flex items-center justify-center border border-gray-100 md:border-0 rounded" title="Edit Permissions">
                                        <i data-lucide="settings-2" class="w-5 h-5 md:w-4 md:h-4"></i>
                                    </a>
                                    <button class="flex-grow md:flex-grow-0 h-11 w-11 bg-gray-50 md:bg-transparent text-gray-400 hover:text-red-600 transition-colors flex items-center justify-center border border-gray-100 md:border-0 rounded" onclick="confirmDelete('Ashish Vinchhi')">
                        ...
                        <tr class="group hover:bg-gray-50/50 transition-all duration-300 block md:table-row mb-4 md:mb-0 border md:border-0 rounded-lg md:rounded-none bg-white md:bg-transparent">
                            <td class="px-6 md:px-8 py-4 md:py-6 block md:table-cell" data-label="Identity Profile">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-[10px] text-gray-400 font-mono tracking-tighter uppercase opacity-70 text-wrap break-all">ripal@ripaldesign.in</p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 md:px-8 py-4 md:py-6 block md:table-cell" data-label="Authorization Level">
                            ...
                            <td class="px-6 md:px-8 py-4 md:py-6 text-gray-400 text-[11px] font-medium italic block md:table-cell" data-label="Last Sync">12 min ago</td>
                            <td class="px-6 md:px-8 py-6 md:py-6 block md:table-cell" data-label="Registry Actions">
                                <div class="flex flex-row md:justify-end gap-3 mt-4 md:mt-0">
                                    <a href="../dashboard/profile.php?user=ripal" class="flex-grow md:flex-grow-0 h-11 w-11 bg-gray-50 md:bg-transparent text-gray-400 hover:text-rajkot-rust transition-colors flex items-center justify-center border border-gray-100 md:border-0 rounded" title="View Profile">
                                        <i data-lucide="eye" class="w-5 h-5 md:w-4 md:h-4"></i>
                                    </a>
                                    <a href="add_user.php?id=2" class="flex-grow md:flex-grow-0 h-11 w-11 bg-gray-50 md:bg-transparent text-gray-400 hover:text-foundation-grey transition-colors flex items-center justify-center border border-gray-100 md:border-0 rounded" title="Edit Permissions">
                                        <i data-lucide="settings-2" class="w-5 h-5 md:w-4 md:h-4"></i>
                                    </a>
                                    <button class="flex-grow md:flex-grow-0 h-11 w-11 bg-gray-50 md:bg-transparent text-gray-400 hover:text-red-600 transition-colors flex items-center justify-center border border-gray-100 md:border-0 rounded" onclick="confirmDelete('Ripal Patel')">
                                        <i data-lucide="trash-2" class="w-5 h-5 md:w-4 md:h-4"></i>
                                    </button>
                                </div>
                            </td>
                        ...
                        <tr class="group hover:bg-gray-50/50 transition-all duration-300 block md:table-row mb-4 md:mb-0 border md:border-0 rounded-lg md:rounded-none bg-white md:bg-transparent">
                            <td class="px-6 md:px-8 py-4 md:py-6 block md:table-cell" data-label="Identity Profile">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-[10px] text-gray-400 font-mono tracking-tighter uppercase opacity-70 text-wrap break-all">sanjay.ahir@field.ripal.in</p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 md:px-8 py-4 md:py-6 block md:table-cell" data-label="Authorization Level">
                            ...
                            <td class="px-6 md:px-8 py-4 md:py-6 text-gray-400 text-[11px] font-medium italic block md:table-cell" data-label="Last Sync">4 hours ago</td>
                            <td class="px-6 md:px-8 py-6 md:py-6 block md:table-cell" data-label="Registry Actions">
                                <div class="flex flex-row md:justify-end gap-3 mt-4 md:mt-0">
                                    <a href="../dashboard/profile.php?user=sanjay" class="flex-grow md:flex-grow-0 h-11 w-11 bg-gray-50 md:bg-transparent text-gray-400 hover:text-rajkot-rust transition-colors flex items-center justify-center border border-gray-100 md:border-0 rounded" title="View Profile">
                                        <i data-lucide="eye" class="w-5 h-5 md:w-4 md:h-4"></i>
                                    </a>
                                    <a href="add_user.php?id=3" class="flex-grow md:flex-grow-0 h-11 w-11 bg-gray-50 md:bg-transparent text-gray-400 hover:text-foundation-grey transition-colors flex items-center justify-center border border-gray-100 md:border-0 rounded" title="Edit Permissions">
                                        <i data-lucide="settings-2" class="w-5 h-5 md:w-4 md:h-4"></i>
                                    </a>
                                    <button class="flex-grow md:flex-grow-0 h-11 w-11 bg-gray-50 md:bg-transparent text-gray-400 hover:text-red-600 transition-colors flex items-center justify-center border border-gray-100 md:border-0 rounded" onclick="confirmDelete('Sanjaybhai Ahir')">
                                        <i data-lucide="trash-2" class="w-5 h-5 md:w-4 md:h-4"></i>
                                    </button>
                                </div>
                            </td>
