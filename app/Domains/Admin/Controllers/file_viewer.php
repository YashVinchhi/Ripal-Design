...
// so private-storage uploads render reliably without direct filesystem URLs.
                ...
                <?php foreach (array_slice($projectLibrary, 0, 80) as $entry): ?>
                  ...
                  <a href="<?php echo htmlspecialchars($entryUrl); ?>" class="block no-underline border rounded p-2 <?php echo $isActiveEntry ? 'border-rajkot-rust bg-red-50' : 'border-gray-100 bg-white hover:border-rajkot-rust'; ?>">
                    ...
                    <p class="text-[10px] text-gray-500 mt-1">
                      ...
                      <?php if (!empty($entry['project_name'])): ?> &bull; <?php echo htmlspecialchars((string)$entry['project_name']); ?><?php endif; ?>
                        <?php if (!empty($entry['uploaded_at'])): ?> &bull; <?php echo htmlspecialchars(date('M d, H:i', strtotime((string)$entry['uploaded_at']))); ?><?php endif; ?>
                          <?php if (!empty($entry['status'])): ?> &bull; <?php echo htmlspecialchars((string)$entry['status']); ?><?php endif; ?>
                    </p>
