    ...
    <header class="bg-foundation-grey text-white pt-24 pb-12 px-4 shadow-lg border-b-2 border-rajkot-rust">
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            <div>
                ...
                <p class="text-gray-400 mt-2 text-sm uppercase tracking-widest font-bold opacity-70">Transparency Engine &bull; <strong class="text-rajkot-rust font-mono"><?php echo htmlspecialchars($projectId); ?></strong></p>
            </div>
