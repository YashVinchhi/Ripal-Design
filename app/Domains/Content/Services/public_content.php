        ...
        $registry = [
            'common_header' => [
                ...
                'fields' => [
                    ...
                    'btn_contact' => ['label' => 'Button: Contact CTA', 'format' => 'plain', 'default' => 'Start Your Project'],
            ...
            'common_footer' => [
                ...
                'fields' => [
                    ...
                    'email' => ['label' => 'Footer Contact Email', 'format' => 'plain', 'default' => 'projects@ripaldesign.studio'],
            ...
            'index' => [
                ...
                'fields' => [
                    ...
                    'testimonial_1_project' => ['label' => 'Testimonial 1 Project', 'format' => 'plain', 'default' => 'Project: Skyline Courtyard Residence'],
                    ...
                    'testimonial_2_project' => ['label' => 'Testimonial 2 Project', 'format' => 'plain', 'default' => 'Project: Jamkhambhalia Cultural Hall'],
                    ...
                    'testimonial_3_project' => ['label' => 'Testimonial 3 Project', 'format' => 'plain', 'default' => 'Project: Rajkot Civic Annex'],
            ...
            'about_us' => [
                ...
                'fields' => [
                    ...
                    'hero_established' => ['label' => 'Hero: Established Label', 'format' => 'plain', 'default' => 'Est. 2017'],
                    'hero_heading' => ['label' => 'Hero: Heading', 'format' => 'plain', 'default' => 'Services & Process'],
                    'hero_subheading' => ['label' => 'Hero: Subheading', 'format' => 'plain', 'default' => 'From site strategy to material detailing, we design spaces that are buildable, measurable, and on-budget.'],
                    'hero_hint' => ['label' => 'Hero: Hint Label', 'format' => 'plain', 'default' => 'Discovery'],
                    'story_heading_line' => ['label' => 'Story Heading First Line', 'format' => 'plain', 'default' => 'Duality in'],
                    'story_heading_highlight' => ['label' => 'Story Heading Highlight', 'format' => 'plain', 'default' => 'Execution'],
                    'story_kicker' => ['label' => 'Story Kicker', 'format' => 'plain', 'default' => 'The Ripal Approach'],
                    ...
                    'team_kicker' => ['label' => 'Team: Kicker', 'format' => 'plain', 'default' => 'Leadership'],
                    'team_heading' => ['label' => 'Team: Heading', 'format' => 'plain', 'default' => 'The Brothers Behind Ripal'],
                    'team_subheading' => ['label' => 'Team: Subheading', 'format' => 'plain', 'default' => 'Design vision and on-site execution, aligned end-to-end.'],
                    'team_1_name' => ['label' => 'Team Member 1 Name', 'format' => 'plain', 'default' => 'Ripal Vinchhi'],
                    'team_1_role' => ['label' => 'Team Member 1 Role', 'format' => 'plain', 'default' => 'Design Director'],
                    'team_1_bio' => ['label' => 'Team Member 1 Bio', 'format' => 'plain', 'default' => 'Leads concept development, spatial strategy, and material direction across residential and public works.'],
                    'team_1_image' => ['label' => 'Team Member 1 Image', 'format' => 'image', 'default' => '/assets/Content/WhatsApp Image 2026-02-02 at 5.02.50 PM.jpeg'],
                    'team_2_name' => ['label' => 'Team Member 2 Name', 'format' => 'plain', 'default' => 'Mayank Vinchhi'],
                    'team_2_role' => ['label' => 'Team Member 2 Role', 'format' => 'plain', 'default' => 'Execution Lead'],
                    'team_2_bio' => ['label' => 'Team Member 2 Bio', 'format' => 'plain', 'default' => 'Oversees on-site delivery, vendor coordination, and schedule integrity.'],
            ...
            'contact_us' => [
                ...
                'fields' => [
                    ...
                    'social_linkedin_url' => ['label' => 'Social URL: LinkedIn', 'format' => 'plain', 'default' => 'https://www.linkedin.com/company/ripal-design-studio/'],
                    'social_behance_label' => ['label' => 'Social Label: Behance', 'format' => 'plain', 'default' => 'Behance'],
                    'map_heading' => ['label' => 'Map Heading', 'format' => 'plain', 'default' => 'Visit the Studio'],
                    'map_link_label' => ['label' => 'Map Link Label', 'format' => 'plain', 'default' => 'Open in Google Maps'],
                    ...
                    'placeholder_first_name' => ['label' => 'Placeholder: First Name', 'format' => 'plain', 'default' => 'Your first name'],
                    'placeholder_last_name' => ['label' => 'Placeholder: Last Name', 'format' => 'plain', 'default' => 'Your last name'],
                    'placeholder_email' => ['label' => 'Placeholder: Email', 'format' => 'plain', 'default' => 'you@company.com'],
                    'placeholder_message' => ['label' => 'Placeholder: Message', 'format' => 'plain', 'default' => 'Tell us about the project scope, site location, and timeline.'],
                    'help_first_name' => ['label' => 'Help Text: First Name', 'format' => 'plain', 'default' => 'Minimum 2 characters.'],
                    'help_last_name' => ['label' => 'Help Text: Last Name', 'format' => 'plain', 'default' => 'Minimum 2 characters.'],
                    'help_email' => ['label' => 'Help Text: Email', 'format' => 'plain', 'default' => 'We will only use this to reply.'],
                    'help_subject' => ['label' => 'Help Text: Subject', 'format' => 'plain', 'default' => 'Choose the project type or consultation.'],
                    'help_message' => ['label' => 'Help Text: Message', 'format' => 'plain', 'default' => 'Minimum 10 characters.'],
            ...
            'login_register' => [
                ...
                'fields' => [
                    ...
                    'signup_welcome_html' => ['label' => 'Welcome Mail: HTML Body (use {{first_name}}, {{full_name}}, {{login_url}})', 'format' => 'html', 'default' => '<h3>Registration Successful</h3><p>Hi {{first_name}},</p><p>Your account was created successfully. You can now log in and start using Ripal Design.</p><p><a href="{{login_url}}">Login to your account</a></p>'],
