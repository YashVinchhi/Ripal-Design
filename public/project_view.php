        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <a href="contact_us.php?subject=residential" class="product-card group cursor-pointer no-underline block">
                    ...
                    <div>
                        <h3 class="text-2xl serif mb-1"><?php echo esc($ct('card_1_title', 'Italian Marble Series')); ?></h3>
                        <p class="text-gray-500 text-sm tracking-wide uppercase"><?php echo esc($ct('card_1_subtitle', 'Flooring & Cladding')); ?></p>
                    </div>
                </a>
                ...
                <a href="contact_us.php?subject=commercial" class="product-card group cursor-pointer no-underline block">
                    ...
                    <div>
                        <h3 class="text-2xl serif mb-1"><?php echo esc($ct('card_2_title', 'Lumina Pendant')); ?></h3>
                        <p class="text-gray-500 text-sm tracking-wide uppercase"><?php echo esc($ct('card_2_subtitle', 'Lighting')); ?></p>
                    </div>
                </a>
                ...
                <a href="contact_us.php?subject=consultation" class="product-card group cursor-pointer no-underline block">
                    ...
                    <div>
                        <h3 class="text-2xl serif mb-1"><?php echo esc($ct('card_3_title', 'Oak Wood Panels')); ?></h3>
                        <p class="text-gray-500 text-sm tracking-wide uppercase"><?php echo esc($ct('card_3_subtitle', 'Interiors')); ?></p>
                    </div>
                </a>
            </div>
