...
<head>
  ...
  <style>
    ...
    /* Grid overlay on the .grain element */
    .grain {
      position: fixed;
      inset: 0;
      pointer-events: none;
    ...
    /* fine grid + subtle major grid lines */
    .grain::before {
      content: "";
      position: absolute;
      inset: 0;
      ...
      /* first two = fine grid, second two = major grid (every 160px) */
...
>>>>>>> a0662a3c0b0ea85e33fd30373162521e5033991a
</html>