...
return [
	...
	'admin.users' => '/admin/user_management.php',
	'admin.add_user' => '/admin/add_user.php',
	'admin.projects' => '/admin/project_management.php',
	'admin.content' => '/admin/content_management.php',
	'admin.contacts' => '/admin/contact_messages.php',
